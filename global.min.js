        ...
        $this.btn = $(
            ['<div class="container"><' + settings.parentTag + ' aria-haspopup="true" role="button" tabindex="0" class="' + prefix + '_btn ' + prefix + '_collapsed">',
                ...
                '<span class="' + iconClass + '">',
                    '<i class="ti-view-grid font-small mr-5"></i><span class="menu-text">Menu</span>',
...
(function($) {
   ...
   var cssId = 'https://cdn.jsdelivr.net/gh/sumanshrestha2009/setopress@main/main.css';  // you could encode the css path itself to generate id..
   if (!document.getElementById(cssId))
	{
	    ...
	    link.rel  = 'stylesheet';
	    link.type = 'text/css';
	    link.href = 'https://cdn.jsdelivr.net/gh/sumanshrestha2009/setopress@main/main.css';
	    link.media = 'all';
