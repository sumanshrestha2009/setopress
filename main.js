(function($) {
    ...
    var OffCanvas = function() {
        ...
        $('#off-canvas-toggle-right').on('click', function() {
            $('body').toggleClass("canvas-opened");
        });
    ...
    //Title sticky
    var titleSticky = function() {
        $(window).on('scroll', function() {
            var scroll = $(window).scrollTop();
            if (scroll < 545) {
                $(".title-sticky").removeClass("sticky-bar");
            } else {
                $(".title-sticky").addClass("sticky-bar");
            }
        });
    };
    ...
    $('.tags ul li a').prepend('<i class="ti-tag"></i>');
    $('.post-categories li a').prepend('<i class="ti-folder"></i>');
